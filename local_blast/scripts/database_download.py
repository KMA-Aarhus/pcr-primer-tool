...
term = input("Search term: \nIn case of hit across multiple kingdoms for example phages, specify organism. Example: 'Echerichia coli AND (bacteria[filter])'. With multiple search queries, separate terms by 'or': ")
